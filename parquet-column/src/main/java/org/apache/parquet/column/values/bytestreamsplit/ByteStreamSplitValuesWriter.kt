...
abstract class ByteStreamSplitValuesWriter(
    ...
    class LongByteStreamSplitValuesWriter(
        ...
        public override fun writeLong(v: Long) {
            super.scatterBytes(longToBytes(v))
        }

        public override fun memUsageString(prefix: String?): String {
            return String.format("%s LongByteStreamSplitWriter %d bytes", prefix, allocatedSize)
        }
    }
    ...
    class FixedLenByteArrayByteStreamSplitValuesWriter(
        ...
        public override fun writeBytes(v: Binary) {
        ...
        public override fun memUsageString(prefix: String?): String {
            return String.format(
                "%s FixedLenByteArrayByteStreamSplitValuesWriter %d bytes", prefix, allocatedSize
            )
        }
    }
}
