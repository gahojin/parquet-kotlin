...
class ColumnWriteStoreV1 : ColumnWriteStoreBase {
    constructor(schema: MessageType, pageWriteStore: PageWriteStore, props: ParquetProperties) :
            super(schema, pageWriteStore, props)

    @Deprecated("")
    constructor(pageWriteStore: PageWriteStore, props: ParquetProperties) : super(pageWriteStore, props)
    ...
    override fun createColumnWriter(
        ...
        return ColumnWriterV1(path, pageWriter, bloomFilterWriter, props)
    }
}
