 ...
 */
class FixedLenByteArrayPlainValuesReader(private val length: Int) : ValuesReader() {
    ...
    companion object {
        private val LOG: Logger = LoggerFactory.getLogger(FixedLenByteArrayPlainValuesReader::class.java)
    }
}
