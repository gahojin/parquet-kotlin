 ...
 */
class AndRecordFilter private constructor(
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun and(filter1: UnboundRecordFilter, filter2: UnboundRecordFilter): UnboundRecordFilter {
            return UnboundRecordFilter {
                AndRecordFilter(filter1.bind(it), filter2.bind(it))
            }
        }
    }
}
